...
typedef enum {
  ...
  POSTTXT_OP = 2,  /// richiesta di invio di un messaggio testuale ad un
                   /// nickname o groupname
  ...
  USRLIST_OP = 7,      /// richiesta di avere la lista di tutti gli utenti
  ...
  /* NOTA: la richiesta di cancellazione di un gruppo e' lasciata come task
     opzionale */
